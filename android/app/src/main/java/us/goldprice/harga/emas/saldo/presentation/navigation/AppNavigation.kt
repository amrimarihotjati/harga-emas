...
package us.goldprice.harga.emas.saldo.presentation.navigation
...
import us.goldprice.harga.emas.saldo.presentation.compare.CompareScreen
import us.goldprice.harga.emas.saldo.presentation.home.HomeScreen
import us.goldprice.harga.emas.saldo.presentation.portfolio.PortfolioScreen
import us.goldprice.harga.emas.saldo.presentation.simulation.SimulationScreen
import us.goldprice.harga.emas.saldo.theme.*
import us.goldprice.harga.emas.saldo.ads.AdManager
import us.goldprice.harga.emas.saldo.presentation.MainUiState
import androidx.compose.runtime.collectAsState
import android.app.Activity

import us.goldprice.harga.emas.saldo.presentation.onegram.OneGramScreen
...
sealed class Screen(val route: String, val title: String, val icon: ImageVector) {
    ...
    object ShareTable : Screen("sharetable", "Tabel", Icons.Default.Share)
}

@Composable
fun AppNavigation(viewModel: MainViewModel, simulationViewModel: us.goldprice.harga.emas.saldo.presentation.simulation.SimulationViewModel) {
    ...
    Scaffold(
        ...
        NavHost(navController, startDestination = Screen.Home.route, Modifier.padding(innerPadding)) {
            ...
            composable(Screen.ShareTable.route) { ShareTableScreen(viewModel) }
        }
    }
}
